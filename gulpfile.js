...
let jsDist = "dist/js/";
let jsWatch = "src/js/**/*";
let jsFiles = ["main.js", "sobre.js"]; //compilar todos os ficheiros js numa array
...
gulp.task('imageMin', function (done) {
    gulp.src('C:/Users/Utilizador/Desktop/Web design/Templates/Full websites/carroNew/src/images')
        .pipe(imageMin([
            //jpg lossless
            imageMin.jpegtran({
                progressive: false
        ...
        .pipe(gulp.dest('C:/Users/Utilizador/Desktop/Web design/Templates/Full websites/carroNew/dist/images'));
    done();
})
